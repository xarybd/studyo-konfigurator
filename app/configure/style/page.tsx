...
import { ChevronLeft, Heart, Zap, Camera, Film } from 'lucide-react'
...
const OPTIONS = [
  ...
  { key: 'vintage', title: 'Vintage & Sinematik', description: 'Film grain, nostaljik palet', icon: <Film size={36} strokeWidth={1.5} /> },
] as const
...
export default function StylePage() {
  ...
  async function handleSelect(key: string) {
    ...
    setTimeout(() => router.push('/configure/location'), 350)
  }
  ...
  return (
    <StepContainer
      step={4}
      title={<><em className="font-accent not-italic italic text-gold-dark">Stiliniz</em> hangisi?</>}
