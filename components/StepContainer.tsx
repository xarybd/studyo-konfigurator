    ...
    >
      <div className="mx-auto flex min-h-[calc(100svh-156px)] w-full max-w-[390px] flex-col justify-start overflow-visible py-7 sm:max-w-[430px] md:max-w-[1120px] md:justify-center md:py-10 lg:py-12">
        <div className="mx-auto w-full max-w-[390px] text-center md:max-w-3xl">
          ...
          <h1 className="mx-auto max-w-[12ch] text-balance text-center font-display text-[clamp(30px,8.7vw,52px)] font-light leading-[1.04] text-ink md:max-w-none md:text-[clamp(38px,6vw,76px)] md:leading-[0.98]">
            {title}
          </h1>

          {subtitle ? (
            <p className="mx-auto mt-3 max-w-[34ch] text-balance text-center font-display text-[13px] italic leading-6 text-ink/50 md:mt-4 md:max-w-xl md:text-[16px] md:leading-7">
              {subtitle}
            </p>
          ) : null}
        </div>
